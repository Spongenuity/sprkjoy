...
function createComponent(_ref) {
  ...
  var Comp = function Comp(_ref2, ref) {
    var _ref2$as = _ref2.as,
        ...
        props = __chunk_1._objectWithoutPropertiesLoose(_ref2, ["as"]);
    ...
    if (useHook) {
      ...
      var _useHook = useHook(_options, __chunk_1._objectSpread({
        ref: ref
      }, htmlProps)),
          unstable_wrap = _useHook.unstable_wrap,
          elementProps = __chunk_1._objectWithoutPropertiesLoose(_useHook, ["unstable_wrap"]); // @ts-ignore


      var asKeys = as.render ? as.render.__keys : as.__keys;
      var asOptions = asKeys ? splitProps.splitProps(props, asKeys)[0] : {};
      var element = useCreateElement$1(as, __chunk_1._objectSpread({}, elementProps, asOptions));
