...
import { f as formatInputName } from '../chunk-80808a2f.js';
import { g as getInputId } from '../chunk-c48e116d.js';
import { g as getLabelId } from '../chunk-2629eed4.js';
import { g as getMessageId, s as shouldShowError } from '../chunk-bcf0431c.js';
...
var unstable_useFormCheckbox = createHook({
  ...
  useCompose: function useCompose(options, htmlProps) {
    ...
    return useCheckbox(_objectSpread({}, options, {
      state: state,
      setState: setState
    }), htmlProps);
  }
