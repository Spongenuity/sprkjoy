...
function useHiddenState(initialState) {
  ...
  var _useSealedState = useSealedState.useSealedState(initialState),
      ...
      hiddenId = _useSealedState$unsta === void 0 ? useId.useId("hidden-") : _useSealedState$unsta,
  ...
  React.useLayoutEffect(function () {
    if (visible || typeof animated !== "number") return undefined; // Stops animation after an interval defined by animated
