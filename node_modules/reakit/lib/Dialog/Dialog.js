...
function useFocusTrap(dialogRef, nestedDialogs, options) {
  ...
  }, [dialogRef, shouldTrap]); // Click trap
...
var useDialog = createHook.createHook({
  ...
  useOptions: function useOptions(_ref) {
    var _ref$modal = _ref.modal,
        ...
        options = __chunk_1._objectWithoutPropertiesLoose(_ref, ["modal", "hideOnEsc", "hideOnClickOutside", "preventBodyScroll", "unstable_autoFocusOnShow", "unstable_autoFocusOnHide", "unstable_portal", "unstable_orphan"]);
  ...
  useProps: function useProps(options, _ref2) {
    var htmlRef = _ref2.ref,
        ...
        htmlProps = __chunk_1._objectWithoutPropertiesLoose(_ref2, ["ref", "onKeyDown", "unstable_wrap"]);
