...
function useTooltipState(initialState) {
  ...
  var _useSealedState = useSealedState.useSealedState(initialState),
      ...
      sealed = __chunk_1._objectWithoutPropertiesLoose(_useSealedState, ["placement", "unstable_boundariesElement"]);

  return PopoverState.usePopoverState(__chunk_1._objectSpread({}, sealed, {
    placement: placement,
