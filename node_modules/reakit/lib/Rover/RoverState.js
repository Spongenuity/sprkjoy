...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case "previous":
      {
        var nextState = reducer(__chunk_1._objectSpread({}, state, {
...
function useRoverState(initialState) {
  ...
  var _useSealedState = useSealedState.useSealedState(initialState),
      ...
      sealed = __chunk_1._objectWithoutPropertiesLoose(_useSealedState, ["currentId", "loop"]);

  var _React$useReducer = React.useReducer(reducer, __chunk_1._objectSpread({}, sealed, {
    stops: [],
    currentId: currentId,
    unstable_pastId: null,
    loop: loop
