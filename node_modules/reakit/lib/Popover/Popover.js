...
var usePopover = createHook.createHook({
  ...
  useOptions: function useOptions(_ref) {
    var _ref$modal = _ref.modal,
        ...
        options = __chunk_1._objectWithoutPropertiesLoose(_ref, ["modal"]);
  ...
  useProps: function useProps(options, _ref2) {
    var htmlRef = _ref2.ref,
        ...
        htmlProps = __chunk_1._objectWithoutPropertiesLoose(_ref2, ["ref", "style"]);

    return __chunk_1._objectSpread({
      ref: mergeRefs.mergeRefs(options.unstable_popoverRef, htmlRef),
      style: __chunk_1._objectSpread({}, options.unstable_popoverStyles, htmlStyle)
    }, htmlProps);
  }
});
