...
var useMenuDisclosure = createHook.createHook({
  ...
  useProps: function useProps(options, _ref) {
    var htmlRef = _ref.ref,
        ...
        htmlProps = __chunk_1._objectWithoutPropertiesLoose(_ref, ["ref", "onClick", "onKeyDown", "onFocus", "onMouseOver"]);
  ...
  useCompose: function useCompose(options, htmlProps) {
    ...
    return PopoverDisclosure.usePopoverDisclosure(__chunk_1._objectSpread({}, options, {
      toggle: noop
    }), htmlProps);
  }
});
