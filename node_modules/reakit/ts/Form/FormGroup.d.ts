...
export declare const unstable_useFormGroup: <V, P extends DeepPath<V, P>>(options: unstable_FormGroupOptions<V, P>, htmlProps?: import("..").RadioGroupHTMLProps | undefined) => import("..").RadioGroupHTMLProps;
