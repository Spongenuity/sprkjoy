...
declare function unstable_useFormState<V = Record<any, any>>(initialState?: SealedInitialState<unstable_FormInitialState<V>>): unstable_FormStateReturn<V>;
declare namespace unstable_useFormState {
    var __keys: ("remove" | "blur" | "reset" | "submit" | "push" | "baseId" | "values" | "touched" | "messages" | "errors" | "validating" | "valid" | "submitting" | "submitSucceed" | "submitFailed" | "validate" | "update")[];
}
export default unstable_useFormState;
