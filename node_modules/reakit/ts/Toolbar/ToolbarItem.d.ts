...
export declare const useToolbarItem: {
    ...
    } & Pick<Partial<import("./ToolbarState").ToolbarStateReturn>, "orientation"> & Pick<import("./ToolbarState").ToolbarStateReturn, "move" | "first" | "last" | "stops" | "currentId" | "register" | "unregister" | "next" | "previous"> & {
