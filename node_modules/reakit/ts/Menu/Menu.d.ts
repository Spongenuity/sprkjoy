...
export declare const useMenu: {
    ...
    __keys: readonly any[];
    __propsAreEqual?: ((prev: Pick<PopoverOptions, "unstable_system" | "visible" | "hide" | "unstable_hiddenId" | "unstable_animated" | "unstable_animating" | "unstable_popoverRef" | "unstable_popoverStyles" | "unstable_stopAnimation" | "unstable_setIsMounted" | "hideOnClickOutside" | "preventBodyScroll" | "unstable_initialFocusRef" | "unstable_finalFocusRef" | "unstable_autoFocusOnShow" | "unstable_autoFocusOnHide"> & Pick<MenuStateReturn, "placement"> & Pick<Partial<MenuStateReturn>, "first" | "last"> & import("..").BoxOptions & Pick<Partial<MenuStateReturn>, "orientation"> & Pick<MenuStateReturn, "move" | "stops" | "next" | "previous"> & React.HTMLAttributes<any> & React.RefAttributes<any> & {
        unstable_wrap?: ((children: React.ReactNode) => JSX.Element) | undefined;
    }, next: Pick<PopoverOptions, "unstable_system" | "visible" | "hide" | "unstable_hiddenId" | "unstable_animated" | "unstable_animating" | "unstable_popoverRef" | "unstable_popoverStyles" | "unstable_stopAnimation" | "unstable_setIsMounted" | "hideOnClickOutside" | "preventBodyScroll" | "unstable_initialFocusRef" | "unstable_finalFocusRef" | "unstable_autoFocusOnShow" | "unstable_autoFocusOnHide"> & Pick<MenuStateReturn, "placement"> & Pick<Partial<MenuStateReturn>, "first" | "last"> & import("..").BoxOptions & Pick<Partial<MenuStateReturn>, "orientation"> & Pick<MenuStateReturn, "move" | "stops" | "next" | "previous"> & React.HTMLAttributes<any> & React.RefAttributes<any> & {
        unstable_wrap?: ((children: React.ReactNode) => JSX.Element) | undefined;
    }) => boolean) | undefined;
};
