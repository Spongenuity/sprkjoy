...
export declare const useMenuDisclosure: {
    ...
    } & Pick<Partial<import("..").HiddenStateReturn>, "visible"> & Pick<import("..").HiddenStateReturn, "unstable_hiddenId" | "toggle"> & Pick<Partial<import("..").TooltipStateReturn>, "unstable_referenceRef"> & Pick<Partial<MenuStateReturn>, "hide"> & Pick<MenuStateReturn, "show" | "first" | "last" | "placement"> & React.HTMLAttributes<any> & React.RefAttributes<any> & {
