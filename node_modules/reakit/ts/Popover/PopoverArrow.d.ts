...
export declare const usePopoverArrow: {
    ...
    __keys: readonly any[];
    __propsAreEqual?: ((prev: BoxOptions & Pick<Partial<import("..").TooltipStateReturn>, "unstable_arrowRef" | "unstable_arrowStyles"> & Pick<import("..").TooltipStateReturn, "placement"> & React.HTMLAttributes<any> & React.RefAttributes<any> & {
        unstable_wrap?: ((children: React.ReactNode) => JSX.Element) | undefined;
    }, next: BoxOptions & Pick<Partial<import("..").TooltipStateReturn>, "unstable_arrowRef" | "unstable_arrowStyles"> & Pick<import("..").TooltipStateReturn, "placement"> & React.HTMLAttributes<any> & React.RefAttributes<any> & {
        unstable_wrap?: ((children: React.ReactNode) => JSX.Element) | undefined;
    }) => boolean) | undefined;
};
