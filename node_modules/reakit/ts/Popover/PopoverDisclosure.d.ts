...
export declare const usePopoverDisclosure: {
    ...
    } & Pick<Partial<import("..").HiddenStateReturn>, "visible"> & Pick<import("..").HiddenStateReturn, "unstable_hiddenId" | "toggle"> & Pick<Partial<import("..").TooltipStateReturn>, "unstable_referenceRef"> & import("react").HTMLAttributes<any> & import("react").RefAttributes<any> & {
