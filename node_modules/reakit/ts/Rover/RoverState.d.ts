...
declare function useRoverState(initialState?: SealedInitialState<RoverInitialState>): RoverStateReturn;
declare namespace useRoverState {
    var __keys: ("move" | "first" | "last" | "orientation" | "stops" | "currentId" | "unstable_pastId" | "loop" | "register" | "unregister" | "next" | "previous" | "unstable_reset" | "unstable_orientate")[];
}
