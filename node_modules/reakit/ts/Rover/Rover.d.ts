...
export declare type RoverOptions = TabbableOptions & Pick<Partial<RoverStateReturn>, "orientation"> & Pick<RoverStateReturn, "stops" | "currentId" | "register" | "unregister" | "move" | "next" | "previous" | "first" | "last"> & {
    /**
     * Element ID.
     */
    stopId?: string;
...
export declare const useRover: {
    ...
    } & Pick<Partial<import("..").ToolbarStateReturn>, "orientation"> & Pick<import("..").ToolbarStateReturn, "move" | "first" | "last" | "stops" | "currentId" | "register" | "unregister" | "next" | "previous"> & {
        /**
         * Element ID.
         */
