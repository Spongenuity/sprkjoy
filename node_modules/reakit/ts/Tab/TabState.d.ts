...
declare function useTabState(initialState?: SealedInitialState<TabInitialState>): TabStateReturn;
declare namespace useTabState {
    var __keys: ("select" | "move" | "first" | "last" | "manual" | "orientation" | "stops" | "currentId" | "unstable_pastId" | "loop" | "register" | "unregister" | "next" | "previous" | "unstable_reset" | "unstable_orientate" | "unstable_baseId" | "selectedId")[];
}
