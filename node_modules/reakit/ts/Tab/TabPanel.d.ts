...
export declare const useTabPanel: {
    ...
    __keys: readonly any[];
    __propsAreEqual?: ((prev: import("..").BoxOptions & Pick<Partial<import("..").HiddenStateReturn>, "visible" | "unstable_hiddenId" | "unstable_animated" | "unstable_animating" | "unstable_stopAnimation" | "unstable_setIsMounted"> & Pick<TabStateReturn, "unstable_baseId" | "selectedId"> & {
        /**
         * Tab's `stopId`.
         */
        stopId: string;
    ...
    }, next: import("..").BoxOptions & Pick<Partial<import("..").HiddenStateReturn>, "visible" | "unstable_hiddenId" | "unstable_animated" | "unstable_animating" | "unstable_stopAnimation" | "unstable_setIsMounted"> & Pick<TabStateReturn, "unstable_baseId" | "selectedId"> & {
        /**
         * Tab's `stopId`.
         */
        stopId: string;
