...
export declare const useCheckbox: {
    (options?: CheckboxOptions | undefined, htmlProps?: import("..").RadioHTMLProps | undefined): import("..").RadioHTMLProps;
    __keys: readonly any[];
    __propsAreEqual?: ((prev: Pick<TabbableOptions, "unstable_system" | "disabled" | "focusable"> & Pick<Partial<CheckboxStateReturn>, "state" | "setState"> & {
        /**
         * Checkbox's value is going to be used when multiple checkboxes share the
         * same state. Checking a checkbox with value will add it to the state
         * array.
    ...
    } & React.InputHTMLAttributes<any>, next: Pick<TabbableOptions, "unstable_system" | "disabled" | "focusable"> & Pick<Partial<CheckboxStateReturn>, "state" | "setState"> & {
        /**
         * Checkbox's value is going to be used when multiple checkboxes share the
         * same state. Checking a checkbox with value will add it to the state
         * array.
